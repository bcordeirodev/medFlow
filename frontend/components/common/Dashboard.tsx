...
type TabType = 'patients' | 'prescriptions' | 'medicines' | 'cids' | 'new-prescription';
...
export default function Dashboard() {
    ...
    const renderContent = () => {
        switch (activeTab) {
            ...
            case 'cids':
                return <CidsList />;
            case 'new-prescription':
                return <EfficientPrescriptionForm onSuccess={() => setActiveTab('prescriptions')} />;
    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
            ...
            <Container maxWidth="xl" sx={{ flexGrow: 1, py: 3, backgroundColor: '#0F172A' }}>
                {renderContent()}
            </Container>
        </Box>
    );
